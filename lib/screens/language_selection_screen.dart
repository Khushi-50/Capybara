...
class _LanguageSelectionScreenState extends State<LanguageSelectionScreen> {
  ...
  Future<void> _saveLanguageToDB() async {
    ...
    // TODO: Connect to your Node.js endpoint: /user/update-language
    // You will send the JWT token in the header and the language in the body
    print("Sending $_selectedLanguage to Backend...");

    await Future.delayed(const Duration(seconds: 1)); // Simulate API call

    setState(() => _isSubmitting = false);

    // Navigate to the Dashboard/Map
